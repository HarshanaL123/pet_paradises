...
class _DogSuppliesPageState extends State<DogSuppliesPage> {
  ...
  Future<List<dynamic>> fetchDogProducts() async {
    ...
    if (response.statusCode == 200) {
      ...
      return allProducts.where((product) => product['category'] == 'dog').toList();
    } else {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: _buildSectionTitle('Explore Our Dog Products', context),
                ),
              ],
            ),
          ),
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Everything your canine friend needs',
                  style: TextStyle(
      ...
      sliver: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return SliverFillRemaining(
              child: Center(child: Text('No dog supplies found')),
            );
          }
